...
extern const WORD gLunarMonthDay[];
extern const BYTE gLunarMonth[];
extern const BYTE gLunarHolDay[];
...
LONG CLunar::CalcDateDiff(WORD iEndYear, WORD iEndMonth, WORD iEndDay,
...
BYTE  CLunar::l_CalcLunarDate(WORD &iYear, WORD &iMonth ,WORD &iDay, LONG iSpanDays)
{
...
WORD CLunar::GetLunarDate(WORD iYear, WORD iMonth, WORD iDay,
...
WORD  CLunar::l_GetLunarHolDay(WORD iYear, WORD iMonth, WORD iDay)
{
...
WORD CLunar::GetLeapMonth(WORD iLunarYear)
{
	BYTE flag = gLunarMonth[(iLunarYear - START_YEAR)/2];
 	return  (iLunarYear - START_YEAR)%2 ? flag&0x0f : flag>>4;
}

LONG CLunar::LunarMonthDays(WORD iLunarYear, WORD iLunarMonth)
{
...
WORD CLunar::LunarYearDays(WORD iLunarYear)
{
...
void CLunar::FormatLunarYear(WORD  iYear, char *pBuffer)
{	
	if(pBuffer==NULL)
	{
		return;
...
void CLunar::FormatMonth(WORD iMonth, char *pBuffer, BOOL bLunar)
{
	if(pBuffer==NULL)
	{
		return;
...
void CLunar::FormatLunarDay(WORD  iDay, char *pBuffer)
{
    char szText1[]="初十廿三";
...
//http://wenku.baidu.com/view/09425b687e21af45b307a803.html 到2100年信息
//数组gLanarMonth存放阴历1901年到2050年闰月的月份，如没有则为0，每字节存两年
const BYTE  gLunarMonth[]=
{
